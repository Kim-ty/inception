...
parser.add_argument(
    '--image',
     default='C:/inception_image/c1.jpg', type=str, help='Absolute path to image file.')
parser.add_argument(
    '--num_top_predictions',
    type=int,
    default=5,
...
,default='C:/inception_image/output_graph.pb',
    type=str,
    help='Absolute path to graph file (.pb)')
parser.add_argument(
    '--labels',
# =C:/tmp/output_labels.txt
    default='C:/inception_image/output_labels.txt',
    type=str,
