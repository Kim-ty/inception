	...
	<table class="table table-striped table-hover">
		...
		<tbody>
			<tr class="active">
				...
				<th>rgwefvadr</th>
				<th>
					<!-- Trigger/Open The Modal onClick with Content--> <span
					id="myBtn" onclick="locationHref();" style="cursor: pointer">
						asdfasdfadfasdfasdfasdfasdfasf </span>
				</th>
				<th>2017/07/04</th>
				<th>3</th>
				<th>Clothes</th>
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<jsp:include page="BoardDetail.jsp"></jsp:include>
