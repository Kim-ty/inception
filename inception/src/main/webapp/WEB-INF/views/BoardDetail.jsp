...
>>>>>>> 4b72e84f0165438c46a34a591f0f16384ac4b5d3
                                 ...
                                 $.ajax({
                                       ...
                                       success : function(replyVO){   
                                          ...
                                          $.each(replyVO,function(key,value){
                                             ...
                                             var row = $("<p>"+ "<span>"+ sibal+ "<span>"+ value.userid+ "&nbsp"+ value.writedate+ "<br>"
                                                   + "<span>"+ sibal+ "<span>"+ value.contents+ "<br>"
                                                   + "<span>"+ sibal+ "<span>"+"<a href='javascript:Replyinsert(" + value.ridx + ")'>답글달기</a></p>");
                                             $("#replycontents").append(row);
                                             $("#comment").val("");
                                             $("#replycount").html(replyVO.length);
                                          });
   ...
   function Replyinsert(ridx) {
      var row = $("<input id='"+ridx+"comment' type='text'></input><button id='"+ridx+"btn' class='submit'>submit</button><input type ='hidden' id='+"+ridx+"+target' value='"+ridx+" '>");
      $(this).append(row);
   }
...
>>>>>>> 4adc399ee08f53aea1a488c7c51c4dc93435a762
</script>
<style>
p img {
         ...
         <div class="row-fluid">
            <div>
               ...
               <div id="boarddetailcontents" style="border: solid black 1px;">
                  ...
                  <div id="reply" style="visibility: hidden;">
                     <div>
                        <input id="comment" type="text"></input><button id="submit" class="submit">submit</button>
                     </div>
                     <div id=replycontents></div>
                  </div>
               </div>
